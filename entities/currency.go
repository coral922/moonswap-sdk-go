 ...
 */
var (
	CONFLUX, _ = newCurrency(constants.Decimals18, "CFX", "Conflux")
)
...
/**
 * newCurrency an instance of the base class `Currency`. The only instance of the base class `Currency` is `Currency.CONFLUX`.
